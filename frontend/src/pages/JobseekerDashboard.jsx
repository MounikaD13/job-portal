  ...
  return (
    <div className="bg-stone-100 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-8 pb-20">
        ...
        {/* Hero Card */}
        <div className="relative overflow-hidden bg-gradient-to-br from-green-800 via-cyan-800 to-green-900 rounded-2xl p-8 flex items-center gap-7 mb-6 flex-col sm:flex-row">
